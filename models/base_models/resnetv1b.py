...
__all__ = ['ResNetV1b', 'resnet18_v1b', 'resnet50_v1b', 'resnet34_v1b',
           'resnet101_v1b', 'resnet18_v1s', 'resnet50_v1s', 'resnet101_v1s', 'resnet152_v1b']
...
def resnet34_v1b(pretrained=False, local_rank=None, **kwargs):
...
def resnet152_v1b(pretrained=False, local_rank=None, **kwargs):
