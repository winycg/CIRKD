...
def get_blend_mask(npimg, dataset='pascal_voc', filename=""):
    """Visualize image.
    ...
    if dataset == 'ade20k':
        npimg = npimg + 1
        mask = adepallete_rgb[npimg]

    elif dataset == 'citys':
        mask = cityspallete_rgb[npimg]
    
    blend_img = 0.3 * np.array(ori_img) + 0.7 * mask
    blend_img = Image.fromarray(blend_img.astype('uint8'))
    return blend_img
...
def _getvocpallete_rgb(vocpallete):
    voc_rgb = []
    sub_list = []
    for i in range(len(vocpallete)):
        if i % 3 == 0 and i != 0:
            voc_rgb.append(sub_list)
            sub_list = []
        sub_list.append(vocpallete[i])
    voc_rgb.append(sub_list)
    return voc_rgb


vocpallete = _getvocpallete(256)
vocpallete_rgb = np.array(_getvocpallete_rgb(vocpallete))
...
adepallete_rgb =np.array([[0, 0, 0], [120, 120, 120], [180, 120, 120], [6, 230, 230], [80, 50, 50], 
...
[0, 255, 112], [0, 255, 133], [255, 0, 0], [255, 163, 0], [255, 102, 0], [194, 255, 0], 
[0, 143, 255], [51, 255, 0], [0, 82, 255], [0, 255, 41], [0, 255, 173], [10, 0, 255], 
[173, 255, 0], [0, 255, 153], [255, 92, 0], [255, 0, 255], [255, 0, 245], [255, 0, 102], 
[255, 173, 0], [255, 0, 20], [255, 184, 184], [0, 31, 255], [0, 255, 61], [0, 71, 255], 
[255, 0, 204], [0, 255, 194], [0, 255, 82], [0, 10, 255], [0, 112, 255], [51, 0, 255], 
[0, 194, 255], [0, 122, 255], [0, 255, 163], [255, 153, 0], [0, 255, 10], [255, 112, 0], 
[143, 255, 0], [82, 0, 255], [163, 255, 0], [255, 235, 0], [8, 184, 170], [133, 0, 255], 
[0, 255, 92], [184, 0, 255], [255, 0, 31], [0, 184, 255], [0, 214, 255], [255, 0, 112], 
[92, 255, 0], [0, 224, 255], [112, 224, 255], [70, 184, 160], [163, 0, 255], [153, 0, 255], 
[71, 255, 0], [255, 0, 163], [255, 204, 0], [255, 0, 143], [0, 255, 235], [133, 255, 0], 
[255, 0, 235], [245, 0, 255], [255, 0, 122], [255, 245, 0], [10, 190, 212], [214, 255, 0],
 [0, 204, 255], [20, 0, 255], [255, 255, 0], [0, 153, 255], [0, 41, 255], [0, 255, 204], 
 [41, 0, 255], [41, 255, 0], [173, 0, 255], [0, 245, 255], [71, 0, 255], [122, 0, 255], 
 [0, 255, 184], [0, 92, 255], [184, 255, 0], [0, 133, 255], [255, 214, 0], [25, 194, 194], 
 [102, 255, 0], [92, 0, 255]])